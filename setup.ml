...
(* OASIS_START *)
(* DO NOT EDIT (digest: 602702c2b3e29065636a02e0e82ba6a6) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$vytree_test", []))];
          ...
          ("reference_tree_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$reference_tree_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("config_tree_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$config_tree_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("vylist_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$vylist_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("value_checker_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$value_checker_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("vyconf_config_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$vyconf_config_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("curly_parser_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$curly_parser_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("util_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$util_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("session_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$session_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "http://vyos.net";
          bugreports = None;
          synopsis = "Appliance configuration framework";
          description = Some [OASISText.Para "VyConf"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Vytree"; "Vylist"; "Value_checker"; "Vyconf_config"
                        ];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("xml-light", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("fileutils", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("ppx_deriving_yojson.runtime", None);
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("lwt.ppx", None);
                           FindlibPackage ("toml", None);
                   ...
                   {exec_custom = false; exec_main_is = "vyconfd.ml"});
               Executable
                 ({
                     cs_name = "vytree_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "vytree_test.ml"});
               Executable
                 ({
                     cs_name = "reference_tree_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "reference_tree_test.ml"
                   });
               Executable
                 ({
                     cs_name = "config_tree_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "config_tree_test.ml"
                   });
               Executable
                 ({
                     cs_name = "vylist_test";
                   ...
                   {exec_custom = false; exec_main_is = "vylist_test.ml"});
               Executable
                 ({
                     cs_name = "value_checker_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "value_checker_test.ml"
                   });
               Executable
                 ({
                     cs_name = "util_test";
                   ...
                   {exec_custom = false; exec_main_is = "util_test.ml"});
               Executable
                 ({
                     cs_name = "vyconf_config_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "vyconf_config_test.ml"
                   });
               Executable
                 ({
                     cs_name = "curly_parser_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "curly_parser_test.ml"
                   });
               Executable
                 ({
                     cs_name = "session_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "session_test.ml"});
               Executable
                 ({
                     cs_name = "vytree_load_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "vytree_load_test.ml"
                   });
               Test
                 ({
                     cs_name = "vytree_test";
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "vytree_test"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "reference_tree_test"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "config_tree_test"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "vylist_test"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "value_checker_test"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "vyconf_config_test"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "curly_parser_test"
                        ]
                   });
               Test
                 ({
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "session_test"
                        ]
                   })
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\164\128uZ\195\226\174r\220\161\232Msu\141\165";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
